...
def get_function_parameters() -> List[s.FunctionParametersOut]:
    return parse_obj_as(
        ...
        [
            ...
            dict(function_parameters=DBMS_REDACT["REDACT_NUM_US_SSN_ENTIRE"]),
            ...
            dict(function_parameters=DBMS_REDACT["REDACT_DATE_MILLENNIUM"]),
            dict(function_parameters=DBMS_REDACT["REDACT_DATE_EPOCH"]),
            dict(function_parameters=DBMS_REDACT["REDACT_AMEX_CCN_FORMATTED"]),
            dict(function_parameters=DBMS_REDACT["REDACT_AMEX_CCN_NUMBER"]),
            dict(function_parameters=DBMS_REDACT["REDACT_SIN_FORMATTED"]),
            dict(function_parameters=DBMS_REDACT["REDACT_SIN_NUMBER"]),
            dict(function_parameters=DBMS_REDACT["REDACT_SIN_UNFORMATTED"]),
            dict(function_parameters=DBMS_REDACT["REDACT_CCN_FORMATTED"]),
            dict(function_parameters=DBMS_REDACT["REDACT_CCN_NUMBER"]),
            dict(function_parameters=DBMS_REDACT["REDACT_NA_PHONE_FORMATTED"]),
            dict(function_parameters=DBMS_REDACT["REDACT_NA_PHONE_NUMBER"]),
            dict(
                function_parameters=DBMS_REDACT["REDACT_NA_PHONE_UNFORMATTED"]
            ),
            dict(function_parameters=DBMS_REDACT["REDACT_UK_NIN_FORMATTED"]),
            dict(function_parameters=DBMS_REDACT["REDACT_UK_NIN_UNFORMATTED"]),
            ...
            dict(function_parameters=DBMS_REDACT["RE_PATTERN_EMAIL_ADDRESS"]),
            ...
            dict(
                function_parameters=DBMS_REDACT["RE_REDACT_CC_MIDDLE_DIGITS"]
            ),
            dict(function_parameters=DBMS_REDACT["RE_REDACT_WITH_SINGLE_X"]),
            dict(function_parameters=DBMS_REDACT["RE_REDACT_WITH_SINGLE_1"]),
            dict(function_parameters=DBMS_REDACT["RE_REDACT_US_PHONE_L7"]),
            dict(function_parameters=DBMS_REDACT["RE_REDACT_EMAIL_NAME"]),
            dict(function_parameters=DBMS_REDACT["RE_REDACT_EMAIL_DOMAIN"]),
            dict(function_parameters=DBMS_REDACT["RE_REDACT_EMAIL_ENTIRE"]),
